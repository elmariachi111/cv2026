  ...
  history: [
    {
      ...
      dur: '~ present',
      logo: 'π',
      logoImage: '/assets/logos/company/peptai_icon.png',
      company: 'PeptAI',
      role: 'DevOps · Agent Infrastructure',
      desc:
        'Agent Fleet Setup - PeptAI runs biomedical research using fleets of computational enabled AI agents that collaborate and evaluate biomedical science hypotheses. Self-service provisioning tier that spins up agent harnesses (openclaw, hermes) on demand on owned VPS hosts, virtual macOS devices and cloud resources.',
    ...
    },
    {
      ...
      dur: 'present',
      logo: 'W',
      logoImage: '/assets/logos/company/welshare_logo.jpeg',
    ...
    },
    {
      ...
      dur: '~ side',
      logo: 'S',
      logoImage: '/assets/logos/company/splice_logo.png',
      company: 'Splice / ETHGlobal',
      role: 'Hackathon Builder',
      desc:
        'ETHOnline 2021 finalist ([SPLICE](https://ethglobal.com/showcase/splice-dzc68) - generative on-chain art splitting royalties to NFT communities). Earlier: decentralized EHRs, DID/VC/VP-based certificate validators.',
    ...
    },
    {
      ...
      dur: '4 yrs',
      logo: 'TK',
      logoImage: '/assets/logos/company/turbinekreuzberg_logo.jpeg',
      company: 'Turbine Kreuzberg',
      role: 'Developer Ambassador',
      desc:
        "Developer Ambassador at one of Berlin's most respected dev shops. Organized meetups for coding.earth across Germany and Portugal. Head curator of [code.talks](https://codetalks.com/) 2022. Pre-sales, internal education, technical writing, conference keynotes.",
    ...
    },
    {
      ...
      dur: '3 yrs',
      logo: 'C',
      logoImage: '/assets/logos/company/mcube_logo.jpg',
      company: 'M-Cube (Check24 Incubator)',
      role: 'Senior Engineer · Comparison Portals',
      desc:
        'Built comparison portals across several Check24 incubator startups. Engines, backends, internal tools, CI/CD, testing infrastructure, growth-hacking & SEO at scale.',
    ...
    },
    {
      ...
      dur: '3 yrs',
      logo: 'D',
      logoImage: '/assets/logos/company/discounto.jpeg',
      company: 'Discounto',
      role: 'Señor Engineer',
      desc:
        'Full-stack work on a product offer search engine - PHP/[Symfony2](https://symfony.com/), performance tuning, build pipelines (Phing), CI setup, backend migration, and frontend templating. End-to-end ownership of a platform with real scaling ambitions.',
    ...
    },
    {
      ...
      dur: '2 yrs',
      logo: 'SDS',
      logoImage: '/assets/logos/company/samsung_sds_logo.jpeg',
      company: 'Samsung SDS',
      role: 'Team Lead · Java Enterprise Engineering',
      desc:
        'Led a team of 8 engineers building Java EE eCommerce applications. Backend work on Oracle SQL, Spring, and iBATIS. Bonus: built a bada restarurant finder app in C++ (Samsung mobile OS)',
    ...
    },
    {
      ...
      dur: '6 yrs',
      logo: 'AD',
      logoImage: '/assets/logos/company/areamobile_sq.webp',
      company: 'AreaDigital AG',
      role: 'Founder · CTO · Editor in Chief',
      desc:
        'Founded, grew and exited AreaDigital AG - a digital media house with >30 employees, 4 publications, homegrown digital service business and data APIs. Publishing partners included IDG.',
